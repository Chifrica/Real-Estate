...
export const Card  = ({onPress} : Props) => {
    return (
      <TouchableOpacity onPress={onPress} className="flex-1 w-full py-4 relative bg-white rounded-lg shadow-lg shadow-black-100/70 mt-5">
            <View className="flex flex-row items-center px-3 absolute p-1 bg-white/90 rounded-full top-5 right-5 z-50">
                <Image source={icons.star} className="size-3.5" />
            ...
            <View className="flex flex-col mt-2">
                ...
                <View className="flex flex-row items-center justify-between mt-2">
                    <Text className="text-base font-rubik-bold text-primar-300">$2,500</Text>
